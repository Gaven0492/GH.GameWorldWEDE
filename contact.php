        ...
        <form action="" method="POST">
            ...
            <div class="formContact">
                ...
                <div class="formButtons">
                    <button name="submit" id="submitButton" class="contactButton"><strong>Submit</strong></button>
                    <button name="reset" id="resetButton" class="contactButton"><strong>Reset</strong></button>
                </div>
            </div>
        </form>
    </div>
